...
const AllUsers = () => {
    ...
    return (
        <div className="mt-10">
           <div className="mr-60"> <SectionTitle subHeading={'MANAGE ALL USERS'} heading={'---How many??---'}></SectionTitle></div>
    ...
    <tbody>
      {/* row 1 */}
      {
        users?.map((user , i)=><tr key={user._id}>
            ...
            <th>
                          <button onClick={()=>handleMaeAdmin(user)}   className="px-2 py-2 text-2xl text-white rounded bg-[#D1A054]"><FaUsers /></button>
                        </th>
